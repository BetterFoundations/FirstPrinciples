...
| [`@firstprinciples/access-control`](packages/access-control) | An isomorphic RBAC/ABAC engine: one JSON rule set, deny-by-default and order-independent, with Express/Fastify/Hono guards and React `<Can>`.     |
